/*
 * @Author: LcLichong 
 * @Date: 2021-05-23 13:25:13 
 * @Last Modified by:   LcLichong 
 * @Last Modified time: 2021-05-23 13:25:13 
 */
...
// html 和 svg 都是标签元素，可以用ELEMENT表示
VNodeFlags.ELEMENT = VNodeFlags.ElEMENT_HTML | VNodeFlags.ELEMENT_SVG
// 普通有状态组件、需要被keepAlive的有状态组件、已经被keepAlive的有状态组件 都是"有状态组件"，统一用 COMPONENT_STATEFUL 表示
